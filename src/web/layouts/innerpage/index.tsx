...
const styleSheet: AppStyleSheet = {
    ...
    'circleOne': 'absolute z-[-1] top-0',
    'circleTwo': 'absolute z-[-1] top:0 right-0',
    'circleThree': 'absolute z-[-1] bottom-0 ',
    ...
    'formWidth': 'w-10/12 lg:w-[45%]'
}


export const Circles = (): React.JSX.Element => {
    return (
        <Box className="absolute top-0 w-full h-full -z-50">
    ...
    return (
        <div className={styleSheet.pageContainer}>
            <div className={`${styleSheet.formWrapper} ${className}`}>
                <div className={styleSheet.formWidth}>
                    <div className='mb-16'>
